...
import sp.microserv.cursos.feignClients.IUsuarioClientFeign;
import sp.microserv.cursos.model.Usuario;
import sp.microserv.cursos.model.dao.ICursoDao;
import sp.microserv.cursos.model.entity.Curso;
import sp.microserv.cursos.model.entity.CursoUsuario;
